...
/* Definitions for peripheral BRAM */
#define XPAR_BRAM_DEVICE_ID 0U
#define XPAR_BRAM_DATA_WIDTH 32U
#define XPAR_BRAM_ECC 0U
#define XPAR_BRAM_FAULT_INJECT 0U
#define XPAR_BRAM_CE_FAILING_REGISTERS 0U
#define XPAR_BRAM_UE_FAILING_REGISTERS 0U
#define XPAR_BRAM_ECC_STATUS_REGISTERS 0U
#define XPAR_BRAM_CE_COUNTER_WIDTH 0U
#define XPAR_BRAM_ECC_ONOFF_REGISTER 0U
#define XPAR_BRAM_ECC_ONOFF_RESET_VALUE 0U
#define XPAR_BRAM_WRITE_ACCESS 0U
#define XPAR_BRAM_S_AXI_BASEADDR 0x40000000U
#define XPAR_BRAM_S_AXI_HIGHADDR 0x40001FFFU
#define XPAR_BRAM_S_AXI_CTRL_BASEADDR 0xFFFFFFFFU  
#define XPAR_BRAM_S_AXI_CTRL_HIGHADDR 0xFFFFFFFFU  


/******************************************************************/

/* Canonical definitions for peripheral BRAM */
#define XPAR_BRAM_0_DEVICE_ID XPAR_BRAM_DEVICE_ID
